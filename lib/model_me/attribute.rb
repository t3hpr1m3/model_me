...
module ModelMe
  class UnsupportedType < ModelMeError; end
  class InvalidConversion < ModelMeError; end
  ...
  class Attribute
    ...
    #
    # Initializes a new Attribute object.  See {ModelMe::AttributeMethods::ClassMethods#attribute attribute}
