module ModelMe
  module AttributeMethods
    ...
    module ClassMethods
      #
      # Adds a new {ModelMe::Attribute} to the ModelMe.
      #
      # @param name [Symbol] Name of the attribute
      # @param data_type [Symbol] One of the suppored
      #   {ModelMe::Attribute::VALID_TYPES data types}
      #   supplied)
    ...
    # Returns the {ModelMe::Attribute Attribute} for the given attribute name
    # @param attr_name [String] Attribute name
    # @return [Attribute] {ModelMe::Attribute} associated with attr_name
